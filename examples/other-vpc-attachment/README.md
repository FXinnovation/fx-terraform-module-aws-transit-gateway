# terraform-module-aws-transit-gateway (other vpc attachment example)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_other_vpc_attachement"></a> [other\_vpc\_attachement](#module\_other\_vpc\_attachement) | ../../ | n/a |
